...
def training(language, exp_path, bert_name, epoch, use_word=False, batch_size=8):
    ...
    model = TransformerEncoderLabelingAnswerable(bert_name, 3, 'mean', tokenizer.vocab[tokenizer.pad], 0.1, 0.2, dropout=0.5, loss_weights=0.2)
...
# training('bengali', './exp/label_ans/test_bn_banglabert', 'sagorsarker/bangla-bert-base', 25, batch_size=12)
...
# training('bengali', './exp/label_ans/test_bn_xlm', 'xlm-roberta-base', 25, batch_size=12)
# # training('indonesian', './exp/label_ans/indo_bert_transformerencoderdecoder_2', 'cahya/bert-base-indonesian-522M', 100) 
# training('indonesian', './exp/label_ans/indonesian_bert_transformerdecoder_start_end_pred', 'cahya/bert-base-indonesian-522M', 25, batch_size=2)
# training('arabic', './exp/label_ans/arabic_bert_transformerdecoder_start_end_pred', 'aubmindlab/bert-base-arabertv2', 20, batch_size=1)