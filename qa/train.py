...
def training(language, exp_path, bert_name, epoch, use_word=False, batch_size=8):
    ...
    model = TransformerEncoderLabelingAnswerable(bert_name, 3, 'mean', tokenizer.vocab[tokenizer.pad], 0.1, 0.2, dropout=0.5, loss_weights=0.3)
...
training('bengali', './exp/label_ans/bengali_bert_transformerencoder_start_end_pred', 'sagorsarker/bangla-bert-base', 25, batch_size=8)
# training('indonesian', './exp/label_ans/indo_bert_transformerencoderdecoder_2', 'cahya/bert-base-indonesian-522M', 100) 
training('indonesian', './exp/label_ans/indonesian_bert_transformerencoder_start_end_pred', 'cahya/bert-base-indonesian-522M', 25, batch_size=4)
training('arabic', './exp/label_ans/arabic_bert_transformerdecoder_start_end_pred', 'aubmindlab/bert-base-arabertv2', 20, batch_size=2)